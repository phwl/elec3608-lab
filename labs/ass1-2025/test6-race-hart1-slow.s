...
/**
 * @brief Two harts competing for the same reservation.  Hart0 attemptys the SC.W
 *      one cycle later than Hart1 and so the H1 store is already in the pipeline.
 *      The Reservation system must handle this, and Hart0 should fail.
...
/* expected result: 
    ...
    expect h0:x3 = 1200
    expect h0:x5 = 1 (fail)
    expect h0:x6 = 0xc1 (193)
*/

/**
 * @brief Hart1 requests memory and stores immediately.  Hart1 should succeed.
 */
...
/* expected result: 
    expect h1:x2 = 0xc1 (core 1 - succeed sc.w )
    expect h1:x5 = 0 (success)
    expect h1:x6 = 0xc1 (193)
*/
