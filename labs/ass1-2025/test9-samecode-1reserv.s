...
/**
 * @brief test Two harts competing for the same reservation at different pointers.  Based on the priorty
 *      you implement (H0=higher in this case) one hart should fail
...
_start:
    ...
    addi x3, zero,  200   /* memory address 200 */
...
/* expected result: 
    ...
    expect h0:x6 = 0xc0 (192)
*/

/**
 * @brief Hart1 code same as Hart0
 */
...
_start1:
    ...
    addi x3, zero, 1200     /* memory address 1200 */
    addi x5, zero, -12      /* dummy result...this should always change after SC.W */
    lr.w x4, (x3)   
    sc.w x5, x2, (x3) 
    lw x6, (x3)             /* read what is actually in memory */
...
/* expected result: 
    ...
    expect h1:x3 = 1200
    expect h1:x5 = 1 (fail)
    expect h1:x6 = 0  (core 0 never wrote here )
*/
