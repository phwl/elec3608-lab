...
/**
 * @brief Two harts competing for the same reservation.  Hart1 attempts the SC.W
 *      one cycle later than Hart0 and so the H0 store is already in the pipeline.
 *      The Reservation system must handle this, and Hart1 should fail.
...
/* expected result: 
    ...
    expect h0:x3 = 1200
    expect h0:x5 = 0 (success)
    expect h0:x6 = 0xc0 (core 0 succeed)
*/
...
/* expected result: 
    ...
    expect h1:x5 = 1 (fail)
    expect h1:x6 = 0xc0 (core 0 succeed)
*/
