...
/**
 * @brief test Two harts competing with different reservations in separate 4k boundaries.  Both should succeed.
...
_start1:
    ...
    addi x3, zero, 1200     /* memory address 4800 */
    slli x3, x3, 2
    addi x5, zero, -12      /* dummy result...this should always change after SC.W */
    lr.w x4, (x3)   
    sc.w x5, x2, (x3) 
