 ...
 */
   ...
   LOOPN:
      ...
      LOOPM:
         ...
         movapd rX0, rA0
         mulpd rY0, rA0
         addpd 64-128(pA0), rA0
         movapd rA0, 64-128(pA0)
         prefA(PFADIST+64(pA0))

         movapd 128-128(pX), rX0
         movapd rX0, rA0
         mulpd rY0, rA0
         addpd 128-128(pA0), rA0
         movapd rA0, 128-128(pA0)
         prefA(PFADIST+128(pA0))

         movapd 192-128(pX), rX0
         movapd rX0, rA0
         mulpd rY0, rA0
         addpd 192-128(pA0), rA0
         movapd rA0, 192-128(pA0)
         prefA(PFADIST+192(pA0))

         movapd 256-128(pX), rX0
         movapd rX0, rA0
         mulpd rY0, rA0
         addpd 256-128(pA0), rA0
         movapd rA0, 256-128(pA0)
         prefA(PFADIST+256(pA0))

         movapd 320-128(pX), rX0
         movapd rX0, rA0
         mulpd rY0, rA0
         addpd 320-128(pA0), rA0
         movapd rA0, 320-128(pA0)
         prefA(PFADIST+320(pA0))

         movapd 384-128(pX), rX0
         movapd rX0, rA0
         mulpd rY0, rA0
         addpd 384-128(pA0), rA0
         movapd rA0, 384-128(pA0)
         ...
         movapd rX0, rA0
         mulpd rY0, rA0
         addpd 80-128(pA0), rA0
         movapd rA0, 80-128(pA0)

         movapd 96-128(pX), rX0
         movapd rX0, rA0
         mulpd rY0, rA0
         addpd 96-128(pA0), rA0
         movapd rA0, 96-128(pA0)

         movapd 112-128(pX), rX0
         movapd rX0, rA0
         mulpd rY0, rA0
         addpd 112-128(pA0), rA0
         movapd rA0, 112-128(pA0)

         movapd 144-128(pX), rX0
         movapd rX0, rA0
         mulpd rY0, rA0
         addpd 144-128(pA0), rA0
         movapd rA0, 144-128(pA0)

         movapd 160-128(pX), rX0
         movapd rX0, rA0
         mulpd rY0, rA0
         addpd 160-128(pA0), rA0
         movapd rA0, 160-128(pA0)

         movapd 176-128(pX), rX0
         movapd rX0, rA0
         mulpd rY0, rA0
         addpd 176-128(pA0), rA0
         movapd rA0, 176-128(pA0)

         movapd 208-128(pX), rX0
         movapd rX0, rA0
         mulpd rY0, rA0
         addpd 208-128(pA0), rA0
         movapd rA0, 208-128(pA0)

         movapd 224-128(pX), rX0
         movapd rX0, rA0
         mulpd rY0, rA0
         addpd 224-128(pA0), rA0
         movapd rA0, 224-128(pA0)

         movapd 240-128(pX), rX0
         movapd rX0, rA0
         mulpd rY0, rA0
         addpd 240-128(pA0), rA0
         movapd rA0, 240-128(pA0)

         movapd 272-128(pX), rX0
         movapd rX0, rA0
         mulpd rY0, rA0
         addpd 272-128(pA0), rA0
         movapd rA0, 272-128(pA0)

         movapd 288-128(pX), rX0
         movapd rX0, rA0
         mulpd rY0, rA0
         addpd 288-128(pA0), rA0
         movapd rA0, 288-128(pA0)

         movapd 304-128(pX), rX0
         movapd rX0, rA0
         mulpd rY0, rA0
         addpd 304-128(pA0), rA0
         movapd rA0, 304-128(pA0)

         movapd 336-128(pX), rX0
         movapd rX0, rA0
         mulpd rY0, rA0
         addpd 336-128(pA0), rA0
         movapd rA0, 336-128(pA0)

         movapd 352-128(pX), rX0
         movapd rX0, rA0
         mulpd rY0, rA0
         addpd 352-128(pA0), rA0
         movapd rA0, 352-128(pA0)

         movapd 368-128(pX), rX0
         movapd rX0, rA0
         mulpd rY0, rA0
         addpd 368-128(pA0), rA0
         movapd rA0, 368-128(pA0)

         movapd 400-128(pX), rX0
         movapd rX0, rA0
         mulpd rY0, rA0
         addpd 400-128(pA0), rA0
         movapd rA0, 400-128(pA0)

         movapd 416-128(pX), rX0
         movapd rX0, rA0
         mulpd rY0, rA0
         addpd 416-128(pA0), rA0
         movapd rA0, 416-128(pA0)

         movapd 432-128(pX), rX0
         movapd rX0, rA0
         mulpd rY0, rA0
         addpd 432-128(pA0), rA0
         movapd rA0, 432-128(pA0)
