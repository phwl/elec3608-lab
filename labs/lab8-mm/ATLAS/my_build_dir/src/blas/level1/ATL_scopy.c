...
void ATL_scopy_xp1yp1aXbX
   (const int, const TYPE*, const int, TYPE*, const int);
void ATL_scopy_xp0yp0aXbX
   (const int, const TYPE*, const int, TYPE*, const int);

void ATL_scopy(const int N, const TYPE *X, const int incX,
...
L1:
      ...
      if (incx == 1 && incy == 1)
         ATL_scopy_xp1yp1aXbX(N, X, incx, Y, incy);
      else
         ATL_scopy_xp0yp0aXbX(N, X, incx, Y, incy);
   }
}
