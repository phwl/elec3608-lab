...
L1:
      ...
      if (incx == 1 && incy == 1)
         ATL_caxpy_xp1yp1aXbX(N, alpha, X, incx, Y, incy);
      else
         ATL_caxpy_xp0yp0aXbX(N, alpha, X, incx, Y, incy);
   }
}
