...
void ATL_zdot_xp1yp1aXbX
   (const int, const TYPE*, const int, const TYPE*, const int, TYPE*);
void ATL_zdot_xp0yp0aXbX
   (const int, const TYPE*, const int, const TYPE*, const int, TYPE*);

void ATL_zdotu_sub(const int N, const TYPE *X, const int incX,
...
L1:
      ...
      if (incx == 1 && incy == 1)
         ATL_zdot_xp1yp1aXbX(N, X, incx, Y, incy, dotc);
      else
         ATL_zdot_xp0yp0aXbX(N, X, incx, Y, incy, dotc);
   }
