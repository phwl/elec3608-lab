...
void ATL_daxpy_xp1yp1aXbX
   (const int, const SCALAR, const TYPE*, const int, TYPE*, const int);
void ATL_daxpy_xp0yp0aXbX
   (const int, const SCALAR, const TYPE*, const int, TYPE*, const int);

void ATL_daxpy(const int N, const SCALAR alpha, const TYPE *X, const int incX,
...
L1:
      ...
      if (incx == 1 && incy == 1)
         ATL_daxpy_xp1yp1aXbX(N, alpha, X, incx, Y, incy);
      else
         ATL_daxpy_xp0yp0aXbX(N, alpha, X, incx, Y, incy);
   }
}
