...
static void ATL_dJIK0x0x53TN1x1x24_a1_bX
 ...
 * lda=53, ldb=53, ldc=0, mu=1, nu=1, ku=24, pf=1
 ...
 */
{
   ...
   #define incAk 24
   const int incAm = 5, incAn = -(53*(Mb));
   #define incBk 24
   const int incBm = -48, incBn = 53;
   #define incCm 1
   ...
   #undef Kb
#endif
void ATL_dJIK0x0x53TN53x53x0_a1_bX
   (const int M, const int N, const int K, const double alpha, const double * ATL_RESTRICT A, const int lda, const double * ATL_RESTRICT B, const int ldb, const double beta, double * ATL_RESTRICT C, const int ldc)
/*
 * matmul with TA=T, TB=N, MB=0, NB=0, KB=53, 
 * lda=53, ldb=53, ldc=0, mu=4, nu=1, ku=24, pf=1
 * Generated by ATLAS/tune/blas/gemm/emit_mm.c (3.10.3)
 */
{
   const int Mb = (M>>2)<<2;
   ...
   const int incPFA = (1 > incPFA0) ? 1 : incPFA0;
   #define incAk 24
   const int incAm = 164, incAn = -(53*(Mb));
   #define incBk 24
   const int incBm = -48, incBn = 53;
   #define incCm 4
   const int incCn = (ldc) - (Mb);
   ...
   if (k=M-Mb)
      ATL_dJIK0x0x53TN1x1x24_a1_bX(k, N, 53, alpha, ca + (53*(Mb)), lda, cb, ldb, beta, cc + (Mb), ldc);
}
#ifdef incAm
   #undef incAm
#endif
