...
static void ATL_dJIK0x0x54TN1x1x24_a1_bX
 ...
 * lda=54, ldb=54, ldc=0, mu=1, nu=1, ku=24, pf=1
...
/*
 * matmul with TA=T, TB=N, MB=0, NB=0, KB=54, 
 * lda=54, ldb=54, ldc=0, mu=4, nu=1, ku=24, pf=1
 * Generated by ATLAS/tune/blas/gemm/emit_mm.c (3.10.3)
 */
{
   const int Mb = (M>>2)<<2;
   ...
   const int incPFA = (1 > incPFA0) ? 1 : incPFA0;
   #define incAk 24
   const int incAm = 168, incAn = -(54*(Mb));
   #define incBk 24
   const int incBm = -48, incBn = 54;
   #define incCm 4
   const int incCn = (ldc) - (Mb);
   ...
   if (k=M-Mb)
      ATL_dJIK0x0x54TN1x1x24_a1_bX(k, N, 54, alpha, ca + (54*(Mb)), lda, cb, ldb, beta, cc + (Mb), ldc);
}
#ifdef incAm
   #undef incAm
#endif
