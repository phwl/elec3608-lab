...
static void ATL_dJIK0x0x0TN1x1x22_a1_bX
 ...
 * lda=0, ldb=0, ldc=0, mu=1, nu=1, ku=22, pf=1
...
/*
 * matmul with TA=T, TB=N, MB=0, NB=0, KB=0, 
 * lda=0, ldb=0, ldc=0, mu=4, nu=1, ku=22, pf=1
 * Generated by ATLAS/tune/blas/gemm/emit_mm.c (3.10.3)
 */
{
   const int Mb = (M>>2)<<2;
   ...
   if (k=M-Mb)
      ATL_dJIK0x0x0TN1x1x22_a1_bX(k, N, K, alpha, ca + (Mb*lda), lda, cb, ldb, beta, cc + (Mb), ldc);
}
#ifdef incAm
   #undef incAm
#endif
