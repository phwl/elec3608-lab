...
static void ATL_dJIK0x0x52TN1x1x24_a1_bX
 ...
 * lda=52, ldb=52, ldc=0, mu=1, nu=1, ku=24, pf=1
 ...
 */
{
   ...
   #define incAk 24
   const int incAm = 4, incAn = -(52*(Mb));
   #define incBk 24
   const int incBm = -48, incBn = 52;
   #define incCm 1
...
/*
 * matmul with TA=T, TB=N, MB=0, NB=0, KB=52, 
 * lda=52, ldb=52, ldc=0, mu=4, nu=1, ku=24, pf=1
 * Generated by ATLAS/tune/blas/gemm/emit_mm.c (3.10.3)
 */
{
   const int Mb = (M>>2)<<2;
   ...
   const int incPFA = (1 > incPFA0) ? 1 : incPFA0;
   #define incAk 24
   const int incAm = 160, incAn = -(52*(Mb));
   #define incBk 24
   const int incBm = -48, incBn = 52;
   #define incCm 4
   const int incCn = (ldc) - (Mb);
   ...
   if (k=M-Mb)
      ATL_dJIK0x0x52TN1x1x24_a1_bX(k, N, 52, alpha, ca + (52*(Mb)), lda, cb, ldb, beta, cc + (Mb), ldc);
}
#ifdef incAm
   #undef incAm
#endif
